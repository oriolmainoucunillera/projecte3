    ...
    function navbar() {
        ?>
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="menu de navegació">
                    ...
                    <div class="d-flex">
                        <?php
                            if (isset($_SESSION['id_usuari_sessio'])) {
                                echo "<a href='meu_perfil.php'>";
                                echo "<img src='imatges/perfil.png' alt='perfil' height='40' width='40'>";
                                echo "</a>";
                                ?>
